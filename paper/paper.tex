...
\newcommand{\hogg}[1]{\textcolor{teal}{Hogg says: #1}}
...
\end{equation}
where we assume isotropy. \KSF{should i give the original Fourier transform before itegrating over orientation?} \hogg{Yes, and say that the second follows from the first.}
